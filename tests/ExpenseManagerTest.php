...
class ExpenseManagerTest extends TestCase
{
    ...
    {
        $this->dbManager = new ExpenseManager(new PDO('mysql:host=localhost;dbname=expense_tracker', 'root', ''));
    ...
    {
        $lastId = $this->dbManager->addExpense(100, 'Food', '2021-10-01', 'Lunch with colleagues');
    ...
    {
        $this->dbManager->addExpense(50, 'Transport', '2021-10-02', 'Bus ticket');
        $this->dbManager->addExpense(30, 'Food', '2021-10-03', 'Coffee');
    ...
    {
        $this->dbManager->addExpense(20, 'Books', '2021-10-05', 'Tech Book');
        $this->dbManager->addExpense(100, 'Food', '2021-10-06', 'Restaurant');

        $filteredExpenses = $this->dbManager->getFilteredExpenses('Food', '2021-10-01', '2021-10-07', 1, 10);
    ...
    {
        $this->dbManager->addExpense(100, 'Food', '2021-10-06', 'Restaurant');
        $this->dbManager->addExpense(40, 'Food', '2021-10-07', 'Fast Food');
